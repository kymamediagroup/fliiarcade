...
(function (Promise) {
  ...
  PC98DosBoxLoader.__proto__ = DosBoxLoader;
   ...
   EmscriptenRunner.prototype.onInit = function (func) {
     this._hooks.init.push(func);
   };
   ...
   function Emulator(canvas, callbacks, loadFiles) {
     ...
     var start = function (options) {
       ...
       function setup_runner() {
         ...
         runner.onInit(() => {
            if (callbacks && callbacks.before_init) {
              callbacks.before_init();
            }
         });
     ...
     function setupFullScreen() {
       ...
       var fullScreenChangeHandler = function() {
                                       if (!(document.mozFullScreenElement || document.fullScreenElement)) {
                                         resizeCanvas(canvas, 1, css_resolution, aspectRatio);
                                       }
                                     };
